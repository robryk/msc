...
We will now use this object in the main result of this work, the implementation of a write-and-$f$-array.
...
One can observe that the version numbers group calls to \fn{write-and-f} into groups of consecutive calls with no 
