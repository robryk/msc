...
\begin{algorithmic}[1]
	...
	\State\var{ver}{\int} % fixme formatting
...
\begin{algorithmic}[1]
	...
	\State\var{$H$}{\arrayspec{N}$\textbf{pair}\left<\int v, \T T\right>$} \Comment{A circular buffer of last $N$ values (except maybe the most recent one)}
